        ...
        <section id="vender" className="mx-auto max-w-4xl px-5 py-20 lg:px-8">
          ...
          <div id="contacto" className="mt-8 rounded-[2rem] border border-white/10 bg-white/10 p-6">
            ...
            <div className="mt-5 flex flex-wrap gap-2.5">
              ...
              <a href="mailto:BiecesJPM@gmail.com" aria-label="Correo" className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-white/20"><svg width="18" height="18" viewBox="0 0 24 24" fill="#fbbf24" aria-hidden="true" className="shrink-0"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg> Correo</a>
            </div>
